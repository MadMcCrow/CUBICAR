...
const FName ABaseCar::EngineAudioRPM("RPM");
...
{
	// Car mesh
	static ConstructorHelpers::FObjectFinder<USkeletalMesh> CarMesh(TEXT("/Game/Vehicles/Default/Vehicle/Vehicle_SkelMesh.Vehicle_SkelMesh"));
	GetMesh()->SetSkeletalMesh(CarMesh.Object);
	
	static ConstructorHelpers::FClassFinder<UObject> AnimBPClass(TEXT("/Game/Vehicles/Default/Vehicle/VehicleAnimationBlueprint"));
	...
	SetupEngine(Vehicle4W);
	SetupTransmission(Vehicle4W);
	SetupSteering(Vehicle4W);
	...
	static ConstructorHelpers::FObjectFinder<USoundCue> SoundCue(TEXT("/Game/Vehicles/Default/Sound/Engine_Loop_Cue.Engine_Loop_Cue"));
...
void ABaseCar::EnableIncarView(const bool bState)
{
...
void ABaseCar::SetupEngine(UWheeledVehicleMovementComponent4W* Vehicle4W)
{
	// Engine 
	// Torque setup
...
void ABaseCar::SetupTransmission(UWheeledVehicleMovementComponent4W* Vehicle4W)
{
	// Transmission	
...
void ABaseCar::SetupSteering(UWheeledVehicleMovementComponent4W* Vehicle4W)
{
	// Adjust the steering 
...
void ABaseCar::UpdatePhysicsMaterial()
{
